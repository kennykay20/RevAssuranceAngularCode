...
@Component({
  selector: 'app-select--to-excel-details',
  templateUrl: './select--to-excel-details.component.html',
  styleUrls: ['./select--to-excel-details.component.scss']
})
export class SelectToExcelDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<SelectToExcelDetailsComponent>,
