...
@Component({
  selector: 'app-batch-counter-details',
  templateUrl: './batch-counter-details.component.html',
  styleUrls: ['./batch-counter-details.component.scss']
})
export class BatchCounterDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<BatchCounterDetailsComponent>,
