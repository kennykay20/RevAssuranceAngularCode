...
@Component({
  selector: 'app-cheque-product-details',
    templateUrl: './cheque-product-details.component.html',
    styleUrls: ['./cheque-product-details.component.scss']
})
export class ChequeProductDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<ChequeProductDetailsComponent>,
      ...
      if(this.data.actionName === 'Add')
      {
        ...
        this.basicForm = this.fb.group({
          chqProductCode: [null, Validators.compose([Validators.required])],
          chqProductDescr: [null, Validators.compose([Validators.required])],
          UserId : 0
      ...
      else
      {
       ...
       this.basicForm.patchValue({
        chqProductCode: data.record.chqProductCode,
        chqProductDescr:  data.record.chqProductDescr,
        ...
        console.log('**data Details this.itbId: ', this.itbId);
        console.log('**data Details this.basicForm.value', this.basicForm.value);
      }
 }
  ...
  update(values: Object): void {
    ...
    element.disabled = true;
      let url = 'ChequeProduct/Update';
    console.log('this.basicForm this.itbId: ', this.itbId);

    this.basicForm.value.itbid = this.itbId;

    console.log('this.basicForm update: ', this.basicForm.value);
