...
@Component({
  selector: 'app-statement-set-up-details',
    templateUrl: './statement-set-up-details.component.html',
    styleUrls: ['./statement-set-up-details.component.scss']
})
export class StatementSetUpDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<StatementSetUpDetailsComponent>,
