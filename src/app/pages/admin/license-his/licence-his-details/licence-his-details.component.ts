...
@Component({
  selector: 'app-licence-his-details',
    templateUrl: './licence-his-details.component.html',
    styleUrls: ['./licence-his-details.component.scss']
})
export class LicenceHisDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<LicenceHisDetailsComponent>,
