...
import {ChargeConcessionListComponent} from '../charge-concession-list/charge-concession-list.component';
declare var $;
  ...
  openDialog(action: any, record: any): void
   {
    ...
    {
      let dialogRef = this.dialog.open(ChargeDetailsComponent, {
      ...
      let dialogRef = this.dialog.open(ChargeConcessionListComponent, {
