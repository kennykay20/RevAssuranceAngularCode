...
@Component({
  selector: 'app-download-log-file-details',
    templateUrl: './download-log-file-details.component.html',
    styleUrls: ['./download-log-file-details.component.scss']
})
export class DownloadLogFileDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<DownloadLogFileDetailsComponent>,
