...
import swal from 'sweetalert2';
import { AcctTypeDetailsComponent } from '../acct-type-details/acct-type-details.component';
...
@Component({
    selector: 'app-acct-type-list',
    templateUrl: './acct-type-list.component.html',
    styleUrls: ['./acct-type-list.component.scss']
})
export class AcctTypeListComponent implements OnInit {
  ...
  openDialog(action: any, record: any): void
   {
    ...
    let dialogRef = this.dialog.open(AcctTypeDetailsComponent, {
