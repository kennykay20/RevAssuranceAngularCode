...
@Component({
  selector: 'app-manage-window-svc-details',
    templateUrl: './manage-window-svc-details.component.html',
    styleUrls: ['./manage-window-svc-details.component.scss']
})
export class ManageWindowSvcDetailsComponent implements OnInit {
  ...
  constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<ManageWindowSvcDetailsComponent>,
