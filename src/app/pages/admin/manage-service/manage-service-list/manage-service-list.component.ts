...
import swal from 'sweetalert2';
import { ManageServiceDetailsComponent } from '../manage-service-details/manage-service-details.component';

declare var $;

@Component({
  selector: 'app-manage-service-list',
    templateUrl: './manage-service-list.component.html',
    styleUrls: ['./manage-service-list.component.scss']
})
export class ManageServiceListComponent implements OnInit {
  ...
  openDialog(action: any, record: any): void
   {
    ...
    let dialogRef = this.dialog.open(ManageServiceDetailsComponent, {
