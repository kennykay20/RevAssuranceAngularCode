  ...
  @Component({
    selector: 'app-my-visitor',
      templateUrl: './my-visitor.component.html',
      styleUrls: ['./my-visitor.component.scss']
  })
  export class MyVisitorComponent implements OnInit {
  ...
  //  @ViewChild('dataTable') table: ElementRef;
   ...
   //   this.ItemsPerPage = this._GeneralService.ItemsPerPage;
    ...
    load(): void {
      ...
      this._GeneralService.getT(token, 'auth/visitors-history?token=')
    ...
    updateFilter(event) {
      ...
      if (this.columnId === 1) {
        ...
        const temp = this.temp.filter(function(d) {
          return d.host_name.toLowerCase().indexOf(val) !== -1 || !val;
        });
      ...
      if (this.columnId === 2) {
        ...
        const temp = this.temp.filter(function(d) {
          return d.visitor_name.toLowerCase().indexOf(val) !== -1 || !val;
        });
