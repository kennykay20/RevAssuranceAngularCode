...
@Component({
  selector: 'app-reg-a-guest',
  templateUrl: './reg-a-guest.component.html',
  styleUrls: ['./reg-a-guest.component.scss']
})
export class RegAGuestComponent implements OnInit {
    ...
    if (this.basicForm.valid) {
      ...
      this._GeneralService.post(values, url).subscribe(
        (data: any) => {
          ...
          let msg  = 'Visitor Created Successfully with code: ' + data.unique_code;
          Swal('', msg, 'success');
