...
@Component({
  selector: 'app-all-fine',
  templateUrl: './all-fine.component.html',
  styleUrls: ['./all-fine.component.scss']
})
export class AllFineComponent implements OnInit {
...
columnId: number;
 ...
 //   this.ItemsPerPage = this._GeneralService.ItemsPerPage;
  ...
  load(): void {
    ...
    this._GeneralService.getT(token, 'auth/all-fines?token=')
