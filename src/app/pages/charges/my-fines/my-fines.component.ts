...
columnId: number;
 ...
 //   this.ItemsPerPage = this._GeneralService.ItemsPerPage;
  ...
  load(): void {
    ...
    this._GeneralService.getT(token, 'auth/my-fines?token=')
   ...
   gotoAddFine(row): void {
    ...
    this._localStorageService.set(this.redirectUrl, './chg/chg'); 
    this.router.navigate(['./chg/all']);
   }
