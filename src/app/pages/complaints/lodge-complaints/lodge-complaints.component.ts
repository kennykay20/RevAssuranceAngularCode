...
// export class  implements OnInit {
  ...
  @Component({
    selector: 'app-lodge-complaints',
    templateUrl: './lodge-complaints.component.html',
    styleUrls: ['./lodge-complaints.component.scss']
  })
  export class LodgeComplaintsComponent implements OnInit {
