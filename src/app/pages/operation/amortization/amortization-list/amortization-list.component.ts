...
@Component({
  selector: 'app-amortization-list',
  templateUrl: './amortization-list.component.html',
  styleUrls: ['./amortization-list.component.scss']
})
export class AmortizationListComponent implements OnInit {
...
apiIsDown = GenModel.apiIsDown;
 ...
 armortizationParam: ArmortizationParam;
  ...
  ngOnInit() 
  {
   ...
   //   this.armortizationParam.pdtEndDate = this.userDetails.bankingDate
    this.statuses = this._GeneralService.statusInDismissed;
      this.loadAll(); 
      this.load();
    this.loadAcctTypes();
  }
    ...
    element.disabled = true;
      ...
      //   }
       ...
       // this.transEnquiry = this.userDetails.userId;
        ...
        console.log('Armortization param', this.armortizationParam);

        let url = 'Armortization/GetAll';
 ...
 clearItem()
 {
   this.armortizationParam.pdtStartDate = '';
   this.armortizationParam.pdtEndDate = '';
   this.armortizationParam.totalAmt = '';
   this.armortizationParam.psCurrencyIso = '';
   this.armortizationParam.psCrAcctNo = '';
   this.armortizationParam.psDrAcctNo = '';
   this.armortizationParam.psStatus = '';
 }
...
dismiss(): void {
  ...
  if(getSelected.length === 0) {
    ...
    Swal({
      ...
      title: '',
      text: 'Are you Sure you want to Dismiss the Selected Transaction(s)?',
      type: 'warning',
      showCancelButton: true,
      confirmButtonText: 'Yes',
      confirmButtonColor: this.btnConfirm, 
