...
@Component({
  ...
  styleUrls: ['./bank-guarantee-list.component.scss']
})
...
summernote1 = "dshsdhdhshdsjdhsdj";
  ...
  ngOnInit() 
  {
    ...
    //  $("#summernote").summernote("code", this.summernote1);
      ...
      this.bankGuarantee = new InstrumentForm();
...
loadAllStatus()
{
  ...
  .subscribe(
    (data: any) => 
    {
      ...
      this.statusItem = this._GeneralService.statusAuthorized;
...
searchHistory()
{
  ...
  let val = 
        {
          transactionDate: this.bankGuarantee.transactionDate,
          acctNo: this.bankGuarantee.acctNo,
          accountName: this.bankGuarantee.acctName,
          acctType: this.bankGuarantee.acctType,
          //pnGlobalView: 'N',
          ServiceId: this.serviceId,
          RoleId: this.assignRole.roleId,
          MenuId:  this.menuId,
          psStatus: this.bankGuarantee.status,
          referenceNo : this.bankGuarantee.referenceNo,
          amount: this.bankGuarantee.amount,
          CcyCode: this.bankGuarantee.ccyCode,
          pnDeptId: this.bankGuarantee.processingDeptId,
          psBranchNo: this.bankGuarantee.branchNo,
        }
...
clearItem(){
  this.bankGuarantee.transactionDate = '';
  this.bankGuarantee.branchNo = '';
  this.bankGuarantee.processingDeptId = null;

  // this.assignRole.roleId,
  // this.menuId,
  this.bankGuarantee.status = '';
  this.bankGuarantee.referenceNo = '';
  this.bankGuarantee.acctNo = '';
  this.bankGuarantee.acctName = '';
  this.bankGuarantee.amount = '';
  this.bankGuarantee.acctType = '';
  this.bankGuarantee.ccyCode = '';
}
...
.retryWhen((err) => {
  ...
  fromDate(events)
  {
    ...
    this.bankGuarantee.transactionDate = dateCon;
  ...
  View(action: any, record: InstrumentForm, createdBy: any): void
   {
    ...
    let dialogRef = this.dialog.open(ApgDetailsComponent, {
      ...
      data: { actionName: action, record:  record, createdBy: createdBy, 
              ...
              serviceName: 'BANK-GUARANTEE',  admService :  this.admService,
