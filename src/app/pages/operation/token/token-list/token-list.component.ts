  ...
  fromDate(events)
{
  var dateCon = this._GeneralService.dateconvertion(events.target.value);
    ...
    this.tokenRequest.transactionDate = dateCon;
    console.log("DateCon ", this.tokenRequest.transactionDate);
}
...
clearItem()
{
  this.tokenRequest.transactionDate = "";
  this.tokenRequest.ccyCode = '';
  this.tokenRequest.status = '';
  this.tokenRequest.acctName = '';
  this.tokenRequest.acctNo = '';
  this.tokenRequest.acctStatus = '';
  this.tokenRequest.acctType = '';
  this.tokenRequest.processingDeptId = '',
  this.tokenRequest.branchNo = '',
  this.tokenRequest.availBal = '',
  this.tokenRequest.referenceNo = ''
}
...
searchHistory()
{
  ...
  let val = {
    transactionDate: this.tokenRequest.transactionDate,
    AcctNo: this.tokenRequest.acctNo,
    AcctType : this.tokenRequest.acctType,
    AcctName: this.tokenRequest.acctName,
    //pnGlobalView: 'N',
    CcyCode: this.tokenRequest.ccyCode,
    RoleId: this.userDetails.roleId,
    MenuId:  this.menuId,
    referenceNo: this.tokenRequest.referenceNo,
    serviceId: this.serviceId,
    availBal: this.tokenRequest.availBal,
    acctStatus: this.tokenRequest.acctStatus,
    pnDeptId: this.tokenRequest.processingDeptId,
    psBranchNo: this.tokenRequest.branchNo
  }

  console.log('Token param search', val);

  let url = 'Token/GetAllSearchHistory';

  this._GeneralService.post(val, url)
  .subscribe((response: any) => {
    //console.log("response Token search " + response._response);
  ...
  View(action: any, record: any, createdBy: any): void {
    ...
    let dialogRef = this.dialog.open(TokenDetailsComponent, {
      ...
      disableClose: true,
      data: {
        actionName: action, record: record,
        createdBy: createdBy, chargeSetup: this.chargeSetup,
        itbId: record.itbId,
        serviceId: this.serviceId
      },
