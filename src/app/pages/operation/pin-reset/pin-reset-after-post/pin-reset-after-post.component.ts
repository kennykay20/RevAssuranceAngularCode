...
@Component({
  selector: 'app-pin-reset-after-post',
  templateUrl: './pin-reset-after-post.component.html',
  styleUrls: ['./pin-reset-after-post.component.scss']
})
export class PinResetAfterPostComponent implements OnInit {

  @ViewChild('dataTable') table: ElementRef;


  name = 'Set iframe source';
  url: string = "http://localhost/RevAssurance/";
  ...
  load(param: any): void {
    ...
    let track = 0;
    let url = 'PinReset/GetAllAfterPost';
  ...
  resetPin(): void {
    ...
    Swal({
      title: '',
      text: 'Are you Sure you want to Reset the Selected transaction(s)?',
      type: 'warning',
      // input: 'number',
      showCancelButton: true,
      confirmButtonText: 'Yes',
      ...
      if (result.value) {
        ...
        let url = 'PinReset/UpdateAfterCharge';

        let val =
        {
          ListoprPinReset: getSelected,
