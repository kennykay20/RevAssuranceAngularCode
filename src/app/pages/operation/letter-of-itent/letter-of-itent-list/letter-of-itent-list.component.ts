...
@Component({
  selector: 'app-letter-of-itent-list',
  templateUrl: './letter-of-itent-list.component.html',
  styleUrls: ['./letter-of-itent-list.component.scss']
})
export class LetterOfItentListComponent implements OnInit {
  ...
  View(action: any, record: InstrumentForm, createdBy: any): void {
    ...
    let dialogRef = this.dialog.open(ApgDetailsComponent, {
      ...
      data: {
        ...
        serviceName: 'LETTER OF INTENT', admService: this.admService,
