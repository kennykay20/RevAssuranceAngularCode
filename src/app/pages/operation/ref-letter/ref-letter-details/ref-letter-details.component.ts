...
@Component({
  selector: 'app-ref-letter-details',
  templateUrl: './ref-letter-details.component.html',
  styleUrls: ['./ref-letter-details.component.scss']
})

export class RefLetterDetailsComponent implements OnInit {
...
dismissedBy: any;
rejectedBy: any;
instrumentForm: ReferenceLetter;
serviceName:any;
...
constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<RefLetterDetailsComponent>,
   ...
   if(data.actionName === 'Ammend' || data.actionName === 'Reprint')
   {
     ...
     this.btnAmendOrReprint = this.actionName;
      ...
      else
      {
        ...
        console.log('ref  data.record',  data.record);
 ...
 resetAction(data)
{
 ...
 reformInstrumentForm() {
    ...
    this.instrumentForm =  new ReferenceLetter();
 ...
 validateColor(){
  ...
  let instrumentForm =  new ReferenceLetter();
  console.log('let validateColor instrumentForm', instrumentForm)
  instrumentForm.acctNo = null;
   for(let key in instrumentForm)
   {
     console.log('Key1 validateColor', key)
...
getById(itbId): void {
    ...
    console.log('getById refletter',itbId);

    this.loadPage = true;

    let track = 0;
    let url = 'ReferenceLetter/GetById';
  ...
  .subscribe(
    (data: any) => 
    {
      ...
      console.log('get  ret letter data', data);
      ...
      this.instrumentForm.acctOpeningDate = this.instrumentForm.acctOpeningDate != null ? this._GeneralService.dateconvertion(this.instrumentForm.acctOpeningDate) : this.instrumentForm.acctOpeningDate;
...
.retryWhen((err) => {
  ...
  (data: any) => 
  {
    ...
    let tmp = new List<Template>(data.temp).Where(c=> c.serviceId == this.serviceId).ToArray();
...
add(values: Object): void {
  ...
  // }
      ...
      if(this.actionName.toLocaleLowerCase() ===  'ammend' || this.actionName.toLocaleLowerCase() ===  'reprint')
      {
        ...
        //   console.log('getWHere', getWHere);
          ...
          this.instrumentForm.itbId = null;
           val = 
          { 
                OprReferenceLetter: this.instrumentForm,
         ...
         url = 'ReferenceLetter/AmmendOrReprint';
      }
    ...
    //   console.log('instrumentForm val', getWHere);
         ...
         { 
          ...
          url = 'ReferenceLetter/Add';
      }  

      console.log('ref add val', val);
  ...
  update(): void {
    ...
    element.disabled = true;
     ...
     let url = 'ReferenceLetter/Update';
           ...
           (data: any) => 
           {
                ...
                // this.instrumentForm.serialNo = this.instrumentForm.serialNo ;
                 ...
                 this.instrumentForm.acctCustNo = data.instrumentAcctDetails.sCustomerId;
                  ...
                  this.instrumentForm.valAcctError =  data.instrumentAcctDetails.nErrorCode ;
                  this.instrumentForm.errorCode =  data.instrumentAcctDetails.nErrorCode ;
                  this.instrumentForm.errorMsg =  data.instrumentAcctDetails.sErrorText ;

                  

                  
                  this.instrumentForm.acctOpeningDate =  data.instrumentAcctDetails.sAcctOpenDate != null ? this._GeneralService.dateconvertion(data.instrumentAcctDetails.sAcctOpenDate) : data.instrumentAcctDetails.sAcctOpenDate;
...
*/
    ...
    const ammendOrReprint = this.actionName.toLocaleLowerCase() == 'ammend' ? true : false
     ...
     let values =  {  
         ...
         this._GeneralService.post(values, url).subscribe(
           (data: any) => 
           {
                 console.log('reprint or Ammend data : ', data);
               // this.instrumentForm.itbId = null;
                 this.instrumentForm.serviceId =  this.serviceId;
                 this.instrumentForm.branchNo = data.instrumentAcctDetails.nBranch;
                 this.instrumentForm.acctType = data.instrumentAcctDetails.sAccountType;  //
  ...
  viewTemp(): void
  {
    ...
    let val = {
      ...
      serviceId : this.serviceId,
      TemplateId: this.instrumentForm.templateId
...
/*
  ...
  if(this.instrumentForm.insurancePremiumPayable == null){
   ...
   getSelectedCharge(templateId)
   {
        ...
        this.instrumentForm.templateId = num;
        this.initiate();
    }
