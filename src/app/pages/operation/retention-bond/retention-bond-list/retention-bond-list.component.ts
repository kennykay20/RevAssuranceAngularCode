...
@Component({
  selector: 'app-retention-bond-list',
  templateUrl: './retention-bond-list.component.html',
  styleUrls: ['./retention-bond-list.component.scss']
})
export class RetentionBondListComponent implements OnInit {
  ...
  View(action: any, record: InstrumentForm, createdBy: any): void {
    ...
    let dialogRef = this.dialog.open(ApgDetailsComponent, {
      ...
      data: {
        ...
        serviceName: 'RETENTION BOND', admService: this.admService,
