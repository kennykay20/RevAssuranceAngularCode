...
@Component({
  selector: 'app-rej-instrument',
  templateUrl: './rej-instrument.component.html',
  styleUrls: ['./rej-instrument.component.scss']
})
export class RejInstrumentComponent implements OnInit {
...
apiIsDown = GenModel.apiIsDown;
 ...
 chargeSetup: any;
  ...
  constructor(public appSettings: AppSettings, public dialog: MatDialog,
    ...
    public dialogRef: MatDialogRef<RejInstrumentComponent>,
