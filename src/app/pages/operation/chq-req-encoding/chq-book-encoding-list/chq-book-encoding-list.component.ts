...
import { ChqBookEncodingDetailsComponent } from '../chq-book-encoding-details/chq-book-encoding-details.component';

declare var $;

@Component({
  selector: 'app-chq-book-encoding-list',
  templateUrl: './chq-book-encoding-list.component.html',
  styleUrls: ['./chq-book-encoding-list.component.scss']
})
export class ChqBookEncodingListComponent implements OnInit {
...
tab2 = '';
  ...
  View(action: any, record: any, createdBy: any): void
   {
    let dialogRef = this.dialog.open(ChqBookEncodingDetailsComponent, {
      width: '1300px',
      height: '600px',
      // hasBackdrop: true,
      disableClose: true,
