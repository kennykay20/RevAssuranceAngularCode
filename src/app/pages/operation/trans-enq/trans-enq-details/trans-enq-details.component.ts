...
@Component({
  selector: 'app-trans-enq-details',
  templateUrl: './trans-enq-details.component.html',
  styleUrls: ['./trans-enq-details.component.scss']
})
export class TransEnqDetailsComponent implements OnInit {
...
constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<TransEnqDetailsComponent>,
