...
@Component({
  selector: 'app-upload-item-details',
  templateUrl: './upload-item-details.component.html',
  styleUrls: ['./upload-item-details.component.scss']
})

export class UploadItemDetailsComponent  implements OnInit {
...
constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<UploadItemDetailsComponent>,
...
getById(record): void {
  ...
  //  console.log('getById itbid Item', record.record.record.batchNo);
    ...
    let track = 0;
    let url = 'BatchControlFileUpload/GetByIdItem';
  ...
  .subscribe(
    (data: any) => 
    {
      ...
      console.log('get batch items Upload data', data);
