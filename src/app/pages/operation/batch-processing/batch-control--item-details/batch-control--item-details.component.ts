...
@Component({
  selector: 'app-batch-control--item-details',
  templateUrl: './batch-control--item-details.component.html',
  styleUrls: ['./batch-control--item-details.component.scss']
})

export class BatchControlItemDetailsComponent  implements OnInit {
...
constructor(public appSettings: AppSettings, 
              ...
              public dialogRef: MatDialogRef<BatchControlItemDetailsComponent>,
...
.retryWhen((err) => {
  ...
  let  valAcct ;
    ...
    let elementDescription = <HTMLInputElement> document.getElementById("txtDescription");
    let elementCcy = <HTMLInputElement> document.getElementById("txtCcyCode");
    //let elementDefautlNar = <HTMLInputElement> document.getElementById("txtDefaultNar");
    if(elementDescription.value == null || elementDescription.value == "")
    {
      Swal('', 'Description is required', 'error');
      return;
    }
    if(elementCcy.value == null || elementCcy.value == "")
    {
      Swal('', 'Currency is required', 'error');
      return;
    }
    // if(elementDefautlNar.value == null || elementDefautlNar.value == "")
    // {
    //   Swal('', 'Default Narration is required', 'error');
    //   return;
    // }
