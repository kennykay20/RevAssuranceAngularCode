...
@Component({
        selector: 'app-all-pending-ann',
        templateUrl: './all-pending-ann.component.html',
        styleUrls: ['./all-pending-ann.component.scss']
})
export class AllPendingAnnComponent implements OnInit {
...
//  @ViewChild('dataTable') table: ElementRef;
 ...
 //   this.ItemsPerPage = this._GeneralService.ItemsPerPage;
  ...
  load(): void {
    ...
    this._GeneralService.getT(token, 'auth/all-pending-announcement?token=')
   ...
   Edit(row: any): void {
    ...
    this._localStorageService.set(this.redirectUrl, './ano/all'); 
    this.router.navigate(['./ano/edit-ann']);
   }
 ...
 let url = `auth/publish-announcement?token=` + token; 
  let value =  
            {
