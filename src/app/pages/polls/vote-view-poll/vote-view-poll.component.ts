...
@Component({
    selector: 'app-vote-view-poll',
    templateUrl: './vote-view-poll.component.html',
    styleUrls: ['./vote-view-poll.component.scss']
})
export class VoteViewPollComponent implements OnInit {
