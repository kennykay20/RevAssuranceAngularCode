...
@Component({
  selector: 'app-decline-user',
  templateUrl: './decline-user.component.html',
  styleUrls: ['./decline-user.component.scss']
})
export class DeclineUserComponent implements OnInit {
...
partnerTypeSelected: string;
 ...
 //   this.ItemsPerPage = this._GeneralService.ItemsPerPage;
  ...
  load(): void {
    ...
    // unauthorized-users
    this._GeneralService.getT(token, 'auth/declined-users?token=')
